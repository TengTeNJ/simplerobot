...
import 'package:tennis_robot/views/pick_page_slider_view.dart';

import '../constant/constants.dart';
import '../models/robot_data_model.dart';
import '../setting/slider_view.dart';
        ...
        Container(
          ...
          child: FutureBuilder<int>(
              ...
              builder: (BuildContext context,AsyncSnapshot<int> value){
                return  PickPageSliderView(defaultValue: ballTypeDefaultValue,chooseValue:(value){
                  if (value == 1.0) {
