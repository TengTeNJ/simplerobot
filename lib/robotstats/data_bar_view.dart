...
/*根据数据量计算宽度*/
  ...
  /* 根据日期筛选数据*/
  Future<void> filterData(String startTime, String endTime) async {
    widget.datas = [];
                ...
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    TTDialog.timeSelect(context, (startTime, endTime ,index){
                      ...
                      if (index == 3) {
                        _titles[_titles.length-1] = "${StringUtil.serviceStringMyStatuDateString(_startTime)}-${StringUtil.serviceStringMyStatuDateString(_endTime)}";
                      }
                      setState(() {});
